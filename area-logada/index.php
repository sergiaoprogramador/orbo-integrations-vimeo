    ...
    <section id="content" class="d-flex">
      <div class="container align-self-center">
        ...
        <div class="row">
                    ...
                    <table class="table-user">
                      ...
                      <tbody>
                        ...
                        <tr class="table-row">
                          ...
                          <td data-hj-suppress="true" class="" id="dataUser"><?= $user['user_nome'] ?></td>
                        </tr>

                        <tr class="table-row">
                          <td class="">E-mail:</td>
                          <td data-hj-suppress="true" class="" id="dataEmail"><?= $user['user_email'] ?></td>
                        </tr>
                        
                        <tr class="table-row">
                          <td class="">Data de nascimento:</td>
                          <td data-hj-suppress="true" class="" id="dataBirthday"><?= $user['user_birthday'] ?></td>
                        </tr>
                        
                        <tr class="table-row">
                          <td class="">Sexo:</td>
                          <td data-hj-suppress="true" class="" id="dataCountry"><?= $user['user_gender'] ?></td>
                        </tr>

                        <tr class="table-row">
                          <td class="">Receber e-mails sobre nossos produtos e serviços:</td>
                          <td data-hj-suppress="true" class="" id="dataCountry"><?= $user['user_marketing'] == 1 ? "aceito" : "não aceito" ?></td>
                        </tr>
          ...
          <div class="col-md-12">
            <a class="cta-edit" href="editProfile.php">Editar perfil</a>
            <a class="cta-edit danger" href="/backend/logout.php" style="margin: 0 0 0 1rem;">Sair</a>
          </div>
